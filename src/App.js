  ...
  return (
    <div className='HowToSection' ref={HowToSectionRefContainer}>
      <div className='HowToSection_bgWrapper'>
        <div className="how_line how_line_1">how - how - how - how - how - how - how</div>
        <div className="how_line how_line_2">how - how<img src={smily_bg} alt="" className='smily_face' /> - how - how<img src={smily_bg} alt="" className='smily_face' /> - how - how<img src={smily_bg} alt="" className='smily_face' /> - how</div>
        <div className="how_line how_line_3">how - how - how - how - how - how - how</div>  
      </div>
      ...
      <div className="howToSection_box_wrapper">
        <Draggable
          ...
          >
          <>
            <div className="moving_box box_1" onMouseEnter={StopAnimation} onMouseLeave={ResumeAnimation}><img src={box_img_1} alt="" /></div>
            <div className="moving_box box_2" onMouseEnter={StopAnimation} onMouseLeave={ResumeAnimation}><img src={box_img_2} alt="" /></div>
            <div className="moving_box box_3" onMouseEnter={StopAnimation} onMouseLeave={ResumeAnimation}><img src={box_img_3} alt="" /></div>
          </>
        </Draggable>
